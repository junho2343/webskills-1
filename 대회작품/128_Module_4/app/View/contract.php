        ...
        <div class="card-body">
          <form action="/addContract" method="post">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="tel" type="text" aria-describedby="emailHelp" value="<?=isMember()['m_phone']?>" name="phone">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="date" type="email" aria-describedby="emailHelp" placeholder="" readonly="readonly" name="date">
            </div>
