      ...
      <div class="mx-auto mt-5" style="max-width: 80rem">
        ...
        <table class="table card-table table-vcenter text-nowrap table-bordered text-center" style="border: 0 0 0 0 !important">
          <tr>
            ...
            <td class="text-left"><?=$car['m_id']?></td>
          </tr>
          <tr>
            <th>차량주명</th>
            <td class="text-left"><?=$car["m_name"]?></td>
          </tr>
          <tr>
            <th>전화번호</th>
            <td class="text-left"><?=$car["m_phone"]?></td>
          </tr>
          <tr>
            <th>차량적재량</th>
            <td class="text-left"><?=$car['m_weight']?>톤</td>
          </tr>
          <tr>
            <th>현차량전체경로</th>
            <td class="text-left"><?=$_GET['path']?></td>
          </tr>
          <tr>
            <th>현위치</th>
            <td class="text-left"><?=$_GET['now']?></td>
          </tr>
        </table>
