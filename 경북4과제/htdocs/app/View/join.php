              ...
              <div class="col-6" style="margin: 0 auto">
                <form action="/join" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="name1" type="text" name="name" aria-describedby="emailHelp" placeholder="한글 또는 영문">
                  </div>
                  <div class="form-group">
                    <label for="tel1">전화번호</label>
                    <input class="form-control" id="tel1" type="text" name="phone" aria-describedby="emailHelp" placeholder="000[2-3자리]-0000[3-4자리]-0000[4자리]">
                  </div>
              ...
              <div class="col-6" style="margin: 0 auto">
                <form action="/join" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="name" type="text" name="name" aria-describedby="emailHelp" placeholder="한글 또는 영문">
                  </div>
                  <div class="form-group">
                    <label for="tel">전화번호</label>
                    <input class="form-control" id="tel" type="text" name="phone" aria-describedby="emailHelp" placeholder="000[2-3자리]-0000[3-4자리]-0000[4자리]">
                  </div>
                  <div class="form-group">
